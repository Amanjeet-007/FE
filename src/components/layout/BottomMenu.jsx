  ...
  return (
    <div className="flex items-center w-full px-4 py-3 md:py-0 fixed top-15 bg-gray-400 z-50">
      ...
      {suggestions.length > 0 && (
        <div className="absolute top-full left-0 right-0 -mt-4 w-[85%] mx-4 bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden max-h-60 overflow-y-auto">
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          fill="currentColor"
        >
          <path d="M22 9.999V20C22 20.5523 21.5523 21 21 21H13V9.999H22ZM11 15.999V21H3C2.44772 21 2 20.5523 2 20V15.999H11ZM11 3V13.999H2V4C2 3.44772 2.44772 3 3 3H11ZM21 3C21.5523 3 22 3.44772 22 4V7.999H13V3H21Z"></path>
        </svg>
      ),
      label: "Store",
    },
            ...
            return (
              ...
              >
                {({ isActive }) => (
                  <>
                    <div
                      className={`transition-all duration-300 ${isActive ? "scale-110 -translate-y-1" : "scale-100"}`}
                    >
                      {el.icon}
                    </div>
                    <span
