        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-6 relative">
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-10">
              ...
              <div className="flex flex-col gap-3 md:gap-4 relative">
                <div className="flex justify-between items-start">
                  ...
                  <div
                    className={`flex items-center px-3 py-1 rounded-full text-white text-xs font-bold ${product.stock < 10 ? "bg-red-500" : "bg-green-500"}`}
                  >
                    Stock: {product.stock}
                  </div>
                </div>
          ...
          <AnimatePresence>
            {isAdded && (
              <motion.div
                initial={
                  isMobile ? { y: 50, opacity: 0 } : { x: 100, opacity: 0 }
                }
              ...
              >
                ...
                <div className="flex flex-col w-full gap-3">
                  <Link
                    to="/checkout"
                    className="bg-black text-white py-3 rounded-xl font-medium hover:bg-gray-800 text-center"
                  >
                    Proceed to Buy
                  </Link>
                  <Link
                    to="/cart"
                    className="border border-black py-3 rounded-xl font-medium hover:bg-gray-50 text-center"
                  >
                    View Cart
                  </Link>
                  <button
                    onClick={() => setIsAdded(false)}
                    className="text-sm text-gray-500 underline mt-2 hover:text-black"
                  >
                    Continue Shopping
                  </button>
                </div>
