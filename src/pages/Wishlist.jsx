...
export default function Wishlist() {
  ...
  const products = false; //later use fetch data and use that
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {/* card navigator */}
      <Link to={"/cart"}>
        <div className="h-20 w-full bg-yellow-400 flex items-center mt-20 justify-between px-5">
          <p className="font-bold text-xl text-blue-600">VIEW CART</p>
          <svg
            width={35}
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="rgba(38,53,185,1)"
          >
      ...
      {products && products.length > 0 ? (
        ...
        <Empty name="Product" message="Empty Wishlist" fnc={()=>{alert("Let's go.")}} />
      )}
